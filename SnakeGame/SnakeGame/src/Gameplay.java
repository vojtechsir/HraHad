...
public class Gameplay extends JPanel implements KeyListener, ActionListener {
	...
	private int [] applexpos = {25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325,
			...
			750, 775, 800, 825, 850};
	private int [] appleypos = {75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325,
	...
	public void paint(Graphics g)
{
		...
		g.drawString ("Délka: " +lengthofsnake, 780, 50);
		
		g.setColor(Color.WHITE);
		g.setFont(new Font("arial", Font.PLAIN, 14));
		g.drawString ("Skóre: " +score, 780, 30);
		...
		for (int b = 1; b < lengthofsnake; b++)
		{
			if (snakexlength [b] == snakexlength [0] && snakeylength [b] == snakeylength [0])
			{
				...
				g.drawString("Prohrál jsi!", 335, 300);
				
				g.setFont(new Font ("arial", Font.BOLD, 20));
				g.drawString("Restartuj hru mezerníkem", 350, 340);
			}
		} 
